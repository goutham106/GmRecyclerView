...
import com.gm.grecyclerview.addon.DragAndDropCallback;
import com.gm.grecyclerview.addon.DragAndDropHelper;
import com.gm.grecyclerview.addon.DragAndDropOptions;
import com.gm.grecyclerview.addon.SnapAlignment;
import com.gm.grecyclerview.addon.StartSnapHelper;
import com.gm.grecyclerview.addon.SwipeDirection;
import com.gm.grecyclerview.addon.SwipeToDismissCallback;
import com.gm.grecyclerview.addon.SwipeToDismissHelper;
import com.gm.grecyclerview.addon.SwipeToDismissOptions;
...
public class GmRecyclerView extends RecyclerView
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
        TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.grv_GmRecyclerView, defStyle, 0);
        layoutMode = typedArray.getInt(R.styleable.grv_GmRecyclerView_grv_layoutMode, 0);
        gridSpanCount = typedArray.getInt(R.styleable.grv_GmRecyclerView_grv_gridSpanCount, 0);
        gridSpanSequence = typedArray.getString(R.styleable.grv_GmRecyclerView_grv_gridSpanSequence);
        spacing = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_spacing, 0);
        verticalSpacing = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_verticalSpacing, 0);
        horizontalSpacing = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_horizontalSpacing, 0);
        isSpacingIncludeEdge = typedArray.getBoolean(R.styleable.grv_GmRecyclerView_grv_isSpacingIncludeEdge, false);
        showDivider = typedArray.getBoolean(R.styleable.grv_GmRecyclerView_grv_showDivider, false);
        showLastDivider = typedArray.getBoolean(R.styleable.grv_GmRecyclerView_grv_showLastDivider, false);
        dividerColor = typedArray.getColor(R.styleable.grv_GmRecyclerView_grv_dividerColor, 0);
        dividerOrientation = typedArray.getInt(R.styleable.grv_GmRecyclerView_grv_dividerOrientation, 2);
        dividerPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_dividerPaddingLeft, 0);
        dividerPaddingRight = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_dividerPaddingRight, 0);
        dividerPaddingTop = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_dividerPaddingTop, 0);
        dividerPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.grv_GmRecyclerView_grv_dividerPaddingBottom, 0);
        isSnappyEnabled = typedArray.getBoolean(R.styleable.grv_GmRecyclerView_grv_snappy, false);
        snapAlignment = typedArray.getInt(R.styleable.grv_GmRecyclerView_grv_snap_alignment, 0);
        emptyStateViewRes = typedArray.getResourceId(R.styleable.grv_GmRecyclerView_grv_emptyStateView, 0);
        typedArray.recycle();
    }
    ...
    // Need to call this method to tell GmRecyclerView to resume checking threshold,
