...
public class SpacingActivity extends BaseActivity {
  ...
  @BindView(R.id.gridSpacingOriRecyclerView)
  GmRecyclerView gridSpacingOriRecyclerView;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    bindBooks(gridSpacingOriRecyclerView);
  ...
  void showLinearVerRecyclerView() {
    ...
    gridSpacingOriRecyclerView.setVisibility(View.GONE);
  ...
  @OnClick(R.id.gridSpacingOriRadioButton)
  void showGridSpacingOriRecyclerView() {
    linearVerRecyclerView.setVisibility(View.GONE);
    linearHorRecyclerView.setVisibility(View.GONE);
    gridRecyclerView.setVisibility(View.GONE);
    gridSpacingOriRecyclerView.setVisibility(View.VISIBLE);
    gridSequenceRecyclerView.setVisibility(View.GONE);
  }
